...
Өөрөөр хэлбэл \({f(x)}\) нь \(x\)-ээс бага бүх анхны  тоонуудын сөрөг биш зэргүүдийг оролцуулан гаргаж болох бүх үржвэрүүдийн  урвуунуудын нийлбэртэй тэнцүү. [Арифметикийн үндсэн теоремоор](http://t8m8r.wordpress.com/2010/04/21/fundamental-theorem-arithmetics/) \(p_1^{k_1}p_2^{k_2}\ldots  p_n^{k_n}\) дотор давтагдах тоо байхгүй. Иймд анхны тоон задаргаандаа  \(p_n\)-ээс их анхны тоог агуулдаггүй тоонуудын олонлогийг
...
Дараах зурагт энэ үр дүнг [Евклидийн баталгаанаас](http://t8m8r.wordpress.com/2010/04/22/euclid-theorem/) гаргасан үнэлэмжтэй жишиж үзүүлэв.
